...
print("The reason that we were not asked to do this in relational algebra is because there is no way of"
      " using aggregate functions. The SUM() function is necessary in order to complete this query "
      "and this is not possible in relational algebra.")
